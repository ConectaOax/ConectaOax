          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="moviles.php">Aplicacion Movil</a></li>
...
<br>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <br>
    <h1> <font color ="#000">Descarga aplicaciones para android</font></h1>
    <table align ="center">
      <tr>
        <td>
         <br>
          <div class="col-lg-4">
          <a href="moviles/ruta.apk" target="_blank"><img class="img-rounded"   data-src="holder.js/200x200" alt="200x200" src="imagenes/descarga.png" style="width: 200px; height: 200px;"></a>
        ...
        <td>
           <br>
          <div class="col-lg-4">
          <a href=""><img class="img-rounded"   data-src="holder.js/200x200" alt="200x200" src="imagenes/descarga.png" style="width: 200px; height: 200px;"></a>
      ...
      <tr>
        <td width="100"><div align = "center"><h3><font color="#000">Agente de trancito Movil</font></h3></div>
        </td>
        <td width="100"></td>
        <td width="100"><div align = "center"><h3><font color="#000">Asistente vial en realidad Aumentada para hipiacusicos</font></h3></div>
        </td>
      </tr>
    </table>
